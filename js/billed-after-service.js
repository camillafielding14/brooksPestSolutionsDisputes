...
function generateBillingInfo() {
    ...
    if (!firstName || !lastName || !amount || !chargeDate || !subType || !agreementDate || !firstServiceDate || !reminderDate || !serviceDate || !saleType) {
    ...
    const sections = [
        ...
        { title: "Filled Per Service Billing Paragraph", content: billingParagraph },
    ...
    sections.forEach((section, index) => {
        ...
        if (["Copy Contact Email", "Filled Per Service Billing Paragraph", "Internal Note"].includes(section.title)) {
